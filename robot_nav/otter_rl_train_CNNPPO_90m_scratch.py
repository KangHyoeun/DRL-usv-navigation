...
def main():
    """Main training function for Otter USV 90m straight navigation - SCRATCH"""
    ...
    max_steps = 1000  # ⭐ 90m requires more steps
    steps = 0
    save_every = 5
    ...
    print("\n" + "=" * 60)
    print("🎯 90m STRAIGHT NAVIGATION - SCRATCH LEARNING")
    print("=" * 60)
    print("   Distance: 90m (4.5x of 20m)")
    print("   Start: (0, -90)")
    print("   Goal: (0, 0)")
    ...
    model = CNNPPO(
        ...
        model_name="otter_CNNPPO_90m_scratch",  # ⭐ 새로운 모델 이름
    ...
    sim = OtterSIM(
        world_file="/worlds/imazu_scenario/s1_90m.yaml",  # ⭐ 90m 환경!
    ...
    while epoch < max_epochs:
        ...
        if episode % episodes_per_epoch == 0 and episode > 0:
            ...
            if avg_reward > best_reward:
                ...
                model.save(filename="otter_CNNPPO_90m_scratch_BEST", directory=best_dir)
    ...
    print(f"   Model name:            otter_CNNPPO_90m_scratch_BEST")
    print("=" * 60)
