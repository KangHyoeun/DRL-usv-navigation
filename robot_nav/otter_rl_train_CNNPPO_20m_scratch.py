...
def main():
    ...
    print("\n" + "=" * 60)
    print("🎯 20m STRAIGHT NAVIGATION - SCRATCH LEARNING")
    print("=" * 60)
    print("   Distance: 20m")
    print("   Start: (0, -20)")
    print("   Goal: (0, 0)")
    ...
    model = CNNPPO(
        ...
        model_name="otter_CNNPPO_20m_scratch",  
    ...
    sim = OtterSIM(
        world_file="/worlds/imazu_scenario/s1.yaml",  # ⭐ 20m 환경!
    ...
    while epoch < max_epochs:
        ...
        if episode % episodes_per_epoch == 0 and episode > 0:
            ...
            if avg_reward > best_reward:
                ...
                model.save(filename="otter_CNNPPO_20m_scratch_BEST", directory=best_dir)
                ...
                with open(best_dir / "best_metrics_20m_scratch.json", 'w') as f:
    ...
    print(f"   Model name:            otter_CNNPPO_20m_scratch_BEST")
    print("=" * 60)
